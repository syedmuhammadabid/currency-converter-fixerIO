...
module.exports = "<app-layout>\n  <div class=\"jumbotron\">\n    <h1>Currency Converter</h1>\n    <p>\n      Currency Converter by using\n      <a href=\"https://fixer.io\">https://fixer.io</a> API.\n    </p>\n  </div>\n  <app-main></app-main>\n</app-layout>\n"
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.init = function () {
        var _this = this;
        this.dataService.currencyRate().subscribe(function (data) {
            _this.rate = data["rates"];
            _this.rateKeys = Object.keys(_this.rate);
            for (var i = 0; i < _this.rateKeys.length; i++) {
                _this.rates.push({
                    code: _this.rateKeys[i],
                    text: _this.rate[_this.rateKeys[i]]
                });
            }
        }, function (err) { });
        this.dataService.currencySymbols().subscribe(function (data) {
            _this.symbol = data["symbols"];
            _this.symbolKeys = Object.keys(_this.symbol);
            for (var i = 0; i < _this.symbolKeys.length; i++) {
                _this.symbols.push({
                    code: _this.symbolKeys[i],
                    text: _this.symbol[_this.symbolKeys[i]]
                });
            }
        }, function (err) { });
    };
    MainComponent.prototype.convert = function () {
        var from = this.newForm.controls["from"].value;
        var to = this.newForm.controls["to"].value;
        var amount = this.newForm.controls["amount"].value;
        var toIndex = lodash__WEBPACK_IMPORTED_MODULE_3__["findIndex"](this.rates, function (rate) {
            return rate.code == to;
        });
        var fromIndex = lodash__WEBPACK_IMPORTED_MODULE_3__["findIndex"](this.rates, function (rate) {
            return rate.code == from;
        });
        var ratio = this.rates[toIndex].text / this.rates[fromIndex].text;
        var cal = ratio * amount;
        this.message =
            amount +
                " " +
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        ...
        this.access_key = "9342f2fd9f2d9f9a34346c1c9e5f2917";
        this.baseURL = "http://data.fixer.io/api/";
    }
    DataService.prototype.currencySymbols = function () {
        return this.http.get(this.baseURL + "symbols?access_key=" + this.access_key);
    };
    DataService.prototype.currencyRate = function () {
...
module.exports = __webpack_require__(/*! D:\Freelance Work\currency-converter\src\main.ts */"./src/main.ts");
